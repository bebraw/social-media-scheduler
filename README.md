...
- A first provider adapter slice for validated Bluesky connections
...
- `src/providers/` holds provider-specific adapter logic such as Bluesky connection preparation.
