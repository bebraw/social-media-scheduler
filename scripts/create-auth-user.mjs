...
function printUsage(exitCode) {
  ...
  output(`Usage:
  npm run account:create -- --name "Scheduler Admin" --password "change-me" --role editor
  npm run account:create -- --name "Read Only" --password "change-me" --role readonly --remote
  npm run account:create -- --name "Scheduler Admin" --password "change-me" --role editor --print-sql
